...
module.exports.handleEvent = async function ({ api, event }) {
    if (!event || !event.body || !(event.body.toLowerCase().startsWith("xi"))) return;
    ...
    if (command === "on") {
        ...
        try {
            api.sendMessage({ body: "🗨️ | Xyrn 𝙰𝙸 𝚒𝚜 𝚜𝚎𝚊𝚛𝚌𝚑𝚒𝚗𝚐 𝚏𝚘𝚛 𝚊𝚗𝚜𝚠𝚎𝚛, 𝙿𝚕𝚎𝚊𝚜𝚎 𝚠𝚊𝚒𝚝..." }, event.threadID, event.messageID);
